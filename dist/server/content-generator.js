...
exports.getSubjectSVG = getSubjectSVG;
 ...
 */
function getSubjectSVG(subject, category) {
 ...
 */
function generateLessonContent(subject, category, gradeLevel) {
 ...
 */
function generateQuizQuestions(subject, category, gradeLevel) {
