...
> **STATUS**: This is a design document. Most features are NOT yet implemented.
>
> **Partially Implemented**:
> - Basic `points_history` table for tracking points awarded
> - Points awarded for lesson completion and quiz scores
> - GET `/api/learner/:learnerId/points-history` endpoint
>
> **Not Yet Implemented**:
> - Rewards catalog and redemption system
> - Learning goals system
> - Enhanced achievements with token rewards
> - Parent rewards management interface
> - Full token economy as described below
