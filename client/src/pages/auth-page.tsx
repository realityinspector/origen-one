...
import { User, Check } from 'react-feather';
...
const AuthPage = () => {
  ...
  // Reset password form (when ?reset=TOKEN is in the URL)
            ...
            <View style={styles.formContainer}>
              {resetSuccess ? (
                ...
                <View>
                  ...
                  <View style={styles.inputGroup}>
                    <Text style={styles.label} nativeID="reset-confirm-password-label">Confirm Password</Text>
                    <TextInput
                      style={styles.input}
                  ...
                  <TouchableOpacity
                    style={[styles.button, resetSubmitting ? styles.buttonDisabled : null]}
                    onPress={handleResetPassword}
                    disabled={resetSubmitting}
                    accessibilityRole="button"
                    accessibilityLabel={resetSubmitting ? 'Resetting password' : 'Reset password'}
          ...
          <View style={styles.cardWrapper}>
            <View style={styles.headerContainer}>
              <View style={styles.logoContainer} aria-hidden={true}>
                <svg width="56" height="56" viewBox="0 0 32 32" aria-hidden={true} focusable="false">
                  <defs>
                    <linearGradient id="authSunG2" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#F5A623" />
                      <stop offset="100%" stopColor="#F97316" />
                    </linearGradient>
                  </defs>
                  <circle cx="16" cy="16" r="8" fill="url(#authSunG2)" />
                  <circle cx="16" cy="16" r="6" fill="none" stroke="#fff" strokeWidth="0.5" opacity="0.3" />
                  <circle cx="16" cy="16" r="2" fill="#fff" opacity="0.6" />
                  <g stroke="#F5A623" strokeWidth="2" strokeLinecap="round" opacity="0.7">
                    <line x1="16" y1="5" x2="16" y2="2" />
            ...
            <View style={styles.formContainer}>
              {forgotSuccess ? (
                ...
                <View>
                  ...
                  <TouchableOpacity
                    style={[styles.button, forgotSubmitting ? styles.buttonDisabled : null]}
                    onPress={handleForgotPassword}
                    disabled={forgotSubmitting}
                    accessibilityRole="button"
                    accessibilityLabel={forgotSubmitting ? 'Sending reset link' : 'Send reset link'}
                    accessibilityState={{ disabled: forgotSubmitting }}
                  >
                    <Text style={styles.buttonText}>
                ...
                <View style={styles.checkboxContainer}>
                  ...
                  >
                    ...
                    <Text style={styles.checkboxText}>
                      I confirm I'm 18+ and accept the{' '}
                      <Text
