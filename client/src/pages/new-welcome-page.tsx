...
import { GitHub, BookOpen, Star, CheckCircle, Users, Award, BarChart2 } from 'react-feather';
...
const styles = StyleSheet.create({
  ...
  howItWorksSection: {
    backgroundColor: colors.primary,
    background: `linear-gradient(135deg, ${colors.primaryDark} 0%, ${colors.accent1} 100%)`,
  },
  timelineContainer: {
    position: 'relative',
    paddingLeft: 16,
