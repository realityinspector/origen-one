...
export class DatabaseStorage implements IStorage {
  ...
  async getLessonHistory(learnerId: string | number | number | number | number | number | number | number | number | number | number | number | number, limit: number = 10): Promise<Lesson[]> {
    try {
